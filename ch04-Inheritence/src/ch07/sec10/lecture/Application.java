...
public class Application {
    public static void main(String[] args) {
        ...
        - 하위 클래스가 상속받아 구현해야 사용가능
        -> 다형성을 활용할 수 있다
         */
        /*
        추상 메서드
        - 메소드 선언부만 있고 구현 부는 없는 메소드
        ...
        System.out.println(public SmartPhone instanceof SmartPhone);
        System.out.println(public SmartPhone instanceof Product);
